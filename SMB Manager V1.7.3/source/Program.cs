...
namespace SmbManager
{
    ...
    {
        private const string AppTitle = "SMB Manager V1.7.3";
        private const string DefaultServerHost = "192.168.1.65";
        private const string CurrentVersionText = "V1.7.3";
        ...
        {
            var split = new SplitContainer { Dock = DockStyle.Fill, SplitterDistance = 360, Panel1MinSize = 180, Panel2MinSize = 180, BackColor = Color.FromArgb(243, 243, 243) };
            _mainSplit = split;
